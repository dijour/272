...
class CampsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create a new camp" do
    assert_difference('Camp.count', 1) do
      post camps_url, params: {camp: { curriculum_id: @camp1.curriculum_id, location_id: @camp1.location_id, cost: 150, start_date: Date.new(2019,8,16), end_date: Date.new(2019,8,20), time_slot: "am", max_students: 10, active: true }}
    end
  ...
  test "should fail to create a new camp" do
    post camps_url, params: {camp: { curriculum_id: false, location_id: @camp1.location_id, cost: @camp1.cost, start_date: Date.new(2019,9,16), end_date: Date.new(2019,9,16), time_slot: @camp1.time_slot, max_students: @camp1.max_students, active: @camp1.active }}
    assert_template :new
  end
  ...
  test "should update a camp" do
    patch camp_url(@camp1), params: {id: @camp1.id, camp: { curriculum_id: @camp1.curriculum_id, location_id: @camp1.location_id, cost: @camp1.cost, start_date: Date.new(2019,10,16), end_date: Date.new(2019,10,16), time_slot: @camp1.time_slot, max_students: 5, active: @camp1.active }}
