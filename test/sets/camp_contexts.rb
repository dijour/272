module Contexts
  module CampContexts
    def create_camps
      ...
      @camp2 = FactoryBot.create(:camp, curriculum: @tactics, start_date: Date.new(2019,7,23), end_date: Date.new(2019,7,27), location: @cmu)
      @camp3 = FactoryBot.create(:camp, curriculum: @tactics, time_slot: "pm", active: false, location: @cmu)
      @camp4 = FactoryBot.create(:camp, curriculum: @endgames, start_date: Date.new(2019,7,23), end_date: Date.new(2019,7,27), time_slot: "pm", location: @cmu)
    end
